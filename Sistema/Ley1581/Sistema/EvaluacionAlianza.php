...
<head>
    ...
    <title>Evaluacion Alianza Oriental</title>
    <link rel="stylesheet" type="text/css" href="CSS/estiles.css"></link>
    <link rel="icon" type="image/jpeg" href="../img/AlianzaOriental.jpeg" />
</head>
<body>
    ...
    <section id='Container'>
        <form method='POST' action='../Controlador/Controlador.php'> <!-- form que envia la información diligenciada en el formulario hacia un controlador -->
            ...
            <h3> ALIANZA ORIENTAL SA<br> Evaluacion Ley 1581 </h3>
            ...
            <input type="submit"  name="BTN_EvaluacionAli" Value="Enviar">
        </form>
    </section>
