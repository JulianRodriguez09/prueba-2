...
session_start();
//guardado de id usuario que se desea eliminar en una variable
$idusuario = $_REQUEST['id'];
//sentencia de SQL SERVER para traer informacion de USuario especifico
...
//guardado de informacion de Usuarios en variables
...
<head>
	...
	<title>Sistema Ley1581 | Eliminar Usuario</title>
</head>
<body>
<?php include "includes/header1.php" ?>
<!--section para formulario de eliminación-->
    <section id="container">
		<form action='Controlador/Controlador.php' method='POST'><!--form para enviar informacion al controlador-->
