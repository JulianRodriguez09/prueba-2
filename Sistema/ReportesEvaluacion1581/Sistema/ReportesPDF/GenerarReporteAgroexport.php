<?php
    ...
    require_once('../../../Model/ModelGenerarReporteAgroexport.php');
    ...
    class PDF extends Fpdf
    {
        ...
        {
            //Logo
            $this->Image('../img/Agroexport.jpeg',15,13,25);
            //Arial bold 15
            ...
            $this->SetY(13);
            $this->SetX(80);
            $this->Cell(50,10,utf8_decode('Reporte Evaluación Agroexport de Colombia S.A.S'),0,0,'C');
            //Descripción PDF
            ...
            $this->SetY(32);
            $this->SetX(80);
            $this->Cell(50,10,' de la empresa Agroexport de Colombia S.A.S' ,0,0,'C');
            $this->SetY(40);
            $this->SetX(80); 
			...
			$this->Cell(30,7,"Cedula:",10,1,'L',0);
