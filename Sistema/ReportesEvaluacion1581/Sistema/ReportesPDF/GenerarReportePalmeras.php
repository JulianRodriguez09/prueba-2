<?php
    ...
    require_once('../../../Model/ModelGenerarReportePalmeras.php');
    ...
    class PDF extends Fpdf
    {
        ...
        {
            //Logo
            $this->Image('../img/PLC.jpeg',15,8,22);
            //Arial bold 15
            ...
            $this->SetY(13);
            $this->SetX(80);
            $this->Cell(50,10,utf8_decode('Reporte Evaluación Palmeras La Carolina S.A'),0,0,'C');
            //Descripción PDF
            ...
            $this->SetY(32);
            $this->SetX(80);
            $this->Cell(50,10,' de la empresa Palmeras La Carolina S.A' ,0,0,'C');
            $this->SetY(40);
            $this->SetX(80); 
