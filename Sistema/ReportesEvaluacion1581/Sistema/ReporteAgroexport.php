...
<!--section para alojar formulario-->
    <section id="containers">
		<form action='buscar_reporteagroexport.php' method='get'><!--form para enviar informacion de input a busqueda-->
			...
			$sqlregister=sqlsrv_query($cc,"SELECT COUNT(*)as totalregistro from PreguntaRespuesta as pr inner join EmpleadosEmpresa as e on pr.IDEmpleadosEmpresa=e.IDEmpleadosEmpresa inner join Empresas as ee on e.IDEmpresas = ee.IDEmpresas  where IDpregunta = 1 and ee.IDEmpresas = '2'");
			...
			//sentencia de SQL SERVER traer informacion de usuarios
			 $sleccionar = sqlsrv_query($cc,"SELECT u.IDUsuarios,em.NombreEmpresa,u.Nombres,u.Apellidos,u.Correo,pr.Fecha,r.Rol 
											...
											where  em.NombreEmpresa = 'AGROEXPORT DE COLOMBIA' and  pr.IDPregunta = 1
