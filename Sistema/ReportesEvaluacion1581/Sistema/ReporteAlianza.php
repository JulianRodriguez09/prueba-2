...
<!--section para alojar formulario-->
	...
	<form action='buscar_reportealianza.php' method='get'> <!--form para enviar informacion de input a busqueda-->
    ...
    <input  type='submit' name='BTN_BuscarReportePalmeras' class='btn_serach1' value='Filtrar'>
		<table> 
			...
			$sqlregister=sqlsrv_query($cc,"SELECT COUNT(*)as totalregistro from PreguntaRespuesta as pr inner join EmpleadosEmpresa as e on pr.IDEmpleadosEmpresa=e.IDEmpleadosEmpresa inner join Empresas as ee on e.IDEmpresas = ee.IDEmpresas  where IDpregunta = 1 and ee.IDEmpresas = '3'");
			...
			//sentencia de SQL SERVER traer informacion de usuarios
			 $sleccionar = sqlsrv_query($cc,"SELECT u.IDUsuarios,em.NombreEmpresa,u.Nombres,u.Apellidos,u.Correo,pr.Fecha,r.Rol 
											...
											where  em.NombreEmpresa = 'ALIANZA ORIETAL S.A.' and  pr.IDPregunta = 1
