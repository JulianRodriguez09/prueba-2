...
<head>
	...
	<title>Sistema Ley1581 | Resumen Anual</title>
...
<section id="containers" >
		<form> 
        <h1>Resumen evaluaciones realisadas <?php echo $fecha ?></h1>
		...
		<div style="margin-top: 10px; " >
                <p style='text-align:center; text-transform: uppercase; font-size: 16pt;'>Explicación gráfica </p>
                <br>
                <p style ='letter-spacing: 1px; font-size: 12pt;'>En esta gráfica se muestra el numero de evaluados mensualmente  y cuantas preguntas fueron contestadas correcta e incorrectamente en el año <?php echo $fecha ?>.</p>
				<br>
				<p style ='letter-spacing: 1px; font-size: 12pt;'>Para ver el resumen general de exito en las evaluaciones ingrese <a href='GraficaGeneral.php'>aquí </a> ó diríjase en la parte superior en el apartado graficos. </p>
				<br>
				<p style ='letter-spacing: 1px; font-size: 12pt;'>Si quiere un resumen de un año en especifico ingrese <a href='ResumenPorAño.php'>aquí </a> ó diríjase en la parte superior en el apartado resumen anual. </p>
				<br>
