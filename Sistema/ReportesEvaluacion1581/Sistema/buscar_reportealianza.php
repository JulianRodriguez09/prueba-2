...
if( $_SESSION['empresa'] != 'ALIANZA ORIETAL S.A.'&$_SESSION['rol'] !='SuperAdmin'){
	echo "<script type='text/javascript'>
    alert('si usted no es un usuario super administrador o usuario de ALIANZA ORIETAL S.A. no tiene acceso a esta opcion, sera redireccionado al inicio');                                                                                           
    </script>";
...
<head>
	...
	<title>Sistema Ley1581 | Reporte Alianza</title>
</head>
...
<!--section para apartar formulario-->
	...
	<form action='buscar_reportealianza.php' method='get'> <!--form para enviar informacion diligenciada en input-->
	<h1>Reportes Alianza Oriental </h1>
	<br>
    ...
    <input  type='submit' name='BTN_BuscarReportePalmeras' class='btn_serach1' value='Filtrar'>
		<table> 
			...
			$sqlregister=sqlsrv_query($cc,"SELECT COUNT(*)as totalregistro from PreguntaRespuesta as p
                                            ...
                                            and IDpregunta = 1 and ee.IDEmpresas = '3'
                                           ");
			...
			if($busqueda == ''&$fech ==''&$fech1 ==''){
                $sleccionar = sqlsrv_query($cc,"SELECT u.IDUsuarios,em.NombreEmpresa,u.Nombres,u.Apellidos,u.Correo,pr.Fecha,r.Rol 
											...
											where  
                                            em.NombreEmpresa = 'ALIANZA ORIETAL S.A.' and  pr.IDPregunta = 1
                ...
                $sleccionar = sqlsrv_query($cc,"SELECT u.IDUsuarios,em.NombreEmpresa,u.Nombres,u.Apellidos,u.Correo,pr.Fecha,r.Rol 
                                            ...
                                            and em.NombreEmpresa = 'ALIANZA ORIETAL S.A.' and  pr.IDPregunta = 1
											order by IDPreguntaRespuesta
											OFFSET $desde ROWS
                                            FETCH NEXT $por_pagina ROWS ONLY");
            ...
            while($columna = sqlsrv_fetch_array($sleccionar)){
                ?>
                    <tr> 
						...
						where IDEstados = 1 and u.IDUsuarios = '".$columna['IDUsuarios']."' and Fecha = '".$result."' and NombreEmpresa = 'ALIANZA ORIETAL S.A.' and evaluar = 'Correcto'");
					...
					?>
                        ...
                        <td> <a href='ReportesPDF/GenerarReporteAlianza.php?id=<?php echo $columna['IDUsuarios'];?>&fech=<?php echo $result;?>' ><img class='photouser' src='img/pdf-logo.png'> </a>  </td>
                    </tr>
